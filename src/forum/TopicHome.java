...
public class TopicHome {
	...
	private static final Logger logger = Logger.getLogger(TopicHome.class.getName());
	...
	public void attachDirty(Topic instance) {
		logger.log(Level.INFO, "attaching dirty Topic instance");
		try {
	...
	public void attachClean(Topic instance) {
		logger.log(Level.INFO, "attaching clean Topic instance");
		try {
	...
	public Topic merge(Topic detachedInstance) {
		logger.log(Level.INFO, "merging Topic instance");
		try {
	...
	public Topic findById(int id) {
		...
		try {
			Topic instance = (Topic) sessionFactory.getCurrentSession().get("forum.Topic", id);
			if (instance == null) {
	...
	public List findByExample(Topic instance) {
		logger.log(Level.INFO, "finding Topic instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("forum.Topic")
