...
public class SectionHome {
	...
	private static final Logger logger = Logger.getLogger(SectionHome.class.getName());
	...
	public void attachDirty(Section instance) {
		logger.log(Level.INFO, "attaching dirty Section instance");
		try {
	...
	public void attachClean(Section instance) {
		logger.log(Level.INFO, "attaching clean Section instance");
		try {
	...
	public Section merge(Section detachedInstance) {
		logger.log(Level.INFO, "merging Section instance");
		try {
			Section result = (Section) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Section findById(int id) {
		...
		try {
			Section instance = (Section) sessionFactory.getCurrentSession().get("forum.Section", id);
			if (instance == null) {
	...
	public List findByExample(Section instance) {
		logger.log(Level.INFO, "finding Section instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("forum.Section")
